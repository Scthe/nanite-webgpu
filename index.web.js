...
`;function ul(n,e,t){let r=t.length/3,o=2**21,[i,l]=vo(t),c=Y.sub(l,i),m=Y.create(o/c[0],o/c[1],o/c[2]),h=Y.mul(i,Y.negate(m)),g=Y.create(),_=C=>Math.floor(Math.min(C,o-1)),x=8,T=new Uint32Array(x+r*2);for(let C=0;C<r;C++){Y.set(t[C*3],t[C*3+1],t[C*3+2],g),Y.mul(g,m,g),Y.add(g,h,g);let R=_(g[0]),N=_(g[1]),L=_(g[2]);T[x+C*2+0]=R,T[x+C*2+0]+=(N&2047)<<21,T[x+C*2+1]=(N&2095104)>>11,T[x+C*2+1]+=L<<10}let M=Y.inverse(m),w=Y.addScaled(i,M,.5),E=new Float32Array(T.buffer,0,8);return E[0]=M[0],E[1]=M[1],E[2]=M[2],E[4]=w[0],E[5]=w[1],E[6]=w[2],Ht(n,`${e}-nanite-vertex-buffer-vec4`,GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST,T)}var cl=P.useVertexQuantization,Od=n=>`
...
${Vn(Mt.meshletsData)}
${rl(Mt.drawnMeshletsParams,"read_write")}
${go(Mt.drawnMeshletsSwParams,"read_write")}
${jn(Mt.drawnMeshletsList,"read_write")}
...
// cull params
${Yn(Mt.drawnInstancesParams,"read")}
// array with results
...
`,Ro=class n{static NAME="DepthPyramidDebugDrawPass";renderPipeline;bindingsCache=new Se;constructor(e,t){this.renderPipeline=n.createRenderPipeline(e,t)}static createRenderPipeline(e,t){let r=e.createShaderModule({label:be(n),code:kd()});return e.createRenderPipeline({label:ve(n),layout:"auto",vertex:{module:r,entryPoint:"main_vs",buffers:[]},fragment:{module:r,entryPoint:"main_fs",targets:[{format:t}]},primitive:{topology:"triangle-list"}})}onViewportResize=()=>this.bindingsCache.clear();cmdDraw(e){let{cmdBuf:t,profiler:r,hdrRenderTexture:o,depthTexture:i}=e,l=t.beginRenderPass({label:n.NAME,colorAttachments:[Oe(o,Le())],timestampWrites:r?.createScopeGpu(n.NAME)}),c=this.bindingsCache.getBindings(i.label,()=>this.createBindings(e));l.setBindGroup(0,c),l.setPipeline(this.renderPipeline),Zn(l),l.end()}createBindings=({device:e,globalUniforms:t,prevFrameDepthPyramidTexture:r})=>{let o=Tl.bindings;return xe(n,"000",e,this.renderPipeline,[t.createBindingDesc(o.renderUniforms),{binding:o.depthPyramidTexture,resource:r}])}};var Cr={workgroupSizeX:32,maxWorkgroupsY:32768,maxMeshletTriangles:`${P.nanite.preprocess.meshletMaxTriangles}u`,bindings:{renderUniforms:0,instancesTransforms:1,dispatchIndirectParams:2,drawnInstanceIdsResult:3,billboardsParams:4,billboardsIdsResult:5,depthPyramidTexture:6,depthSampler:7}},Al=Cr,Jt=Cr.bindings,Il=()=>`
...
`;var ta={bindings:{renderUniforms:0,instancesTransforms:1,wholeObjectCullData:2,billboardsIdsResult:3,impostorTexture:4,sampler:5}},Qn=ta.bindings,Cl=()=>`
