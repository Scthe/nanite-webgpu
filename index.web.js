...
</div>`,nd=function(e,n){var r=e[n];return I.isArray(arguments[2])||I.isObject(arguments[2])?new Xf(e,n,arguments[2]):I.isNumber(r)?I.isNumber(arguments[2])&&I.isNumber(arguments[3])?I.isNumber(arguments[4])?new Gi(e,n,arguments[2],arguments[3],arguments[4]):new Gi(e,n,arguments[2],arguments[3]):I.isNumber(arguments[4])?new Qr(e,n,{min:arguments[2],max:arguments[3],step:arguments[4]}):new Qr(e,n,{min:arguments[2],max:arguments[3]}):I.isString(r)?new Kf(e,n):I.isFunction(r)?new Cs(e,n,""):I.isBoolean(r)?new Is(e,n):null};function rd(t){setTimeout(t,1e3/60)}var od=window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||rd,id=function(){function t(){pt(this,t),this.backgroundElement=document.createElement("div"),I.extend(this.backgroundElement.style,{backgroundColor:"rgba(0,0,0,0.8)",top:0,left:0,display:"none",zIndex:"1000",opacity:0,WebkitTransition:"opacity 0.2s linear",transition:"opacity 0.2s linear"}),M.makeFullscreen(this.backgroundElement),this.backgroundElement.style.position="fixed",this.domElement=document.createElement("div"),I.extend(this.domElement.style,{position:"fixed",display:"none",zIndex:"1001",opacity:0,WebkitTransition:"-webkit-transform 0.2s ease-out, opacity 0.2s linear",transition:"transform 0.2s ease-out, opacity 0.2s linear"}),document.body.appendChild(this.backgroundElement),document.body.appendChild(this.domElement);var e=this;M.bind(this.backgroundElement,"click",function(){e.hide()})}return ht(t,[{key:"show",value:function(){var n=this;this.backgroundElement.style.display="block",this.domElement.style.display="block",this.domElement.style.opacity=0,this.domElement.style.webkitTransform="scale(1.1)",this.layout(),I.defer(function(){n.backgroundElement.style.opacity=1,n.domElement.style.opacity=1,n.domElement.style.webkitTransform="scale(1)"})}},{key:"hide",value:function(){var n=this,r=function o(){n.domElement.style.display="none",n.backgroundElement.style.display="none",M.unbind(n.domElement,"webkitTransitionEnd",o),M.unbind(n.domElement,"transitionend",o),M.unbind(n.domElement,"oTransitionEnd",o)};M.bind(this.domElement,"webkitTransitionEnd",r),M.bind(this.domElement,"transitionend",r),M.bind(this.domElement,"oTransitionEnd",r),this.backgroundElement.style.opacity=0,this.domElement.style.opacity=0,this.domElement.style.webkitTransform="scale(1.1)"}},{key:"layout",value:function(){this.domElement.style.left=window.innerWidth/2-M.getWidth(this.domElement)/2+"px",this.domElement.style.top=window.innerHeight/2-M.getHeight(this.domElement)/2+"px"}}]),t}(),ad=Hf(`.dg ul{list-style:none;margin:0;padding:0;width:100%;clear:both}.dg.ac{position:fixed;top:0;left:0;right:0;height:0;z-index:0}.dg:not(.ac) .main{overflow:hidden}.dg.main{-webkit-transition:opacity .1s linear;-o-transition:opacity .1s linear;-moz-transition:opacity .1s linear;transition:opacity .1s linear}.dg.main.taller-than-window{overflow-y:auto}.dg.main.taller-than-window .close-button{opacity:1;margin-top:-1px;border-top:1px solid #2c2c2c}.dg.main ul.closed .close-button{opacity:1 !important}.dg.main:hover .close-button,.dg.main .close-button.drag{opacity:1}.dg.main .close-button{-webkit-transition:opacity .1s linear;-o-transition:opacity .1s linear;-moz-transition:opacity .1s linear;transition:opacity .1s linear;border:0;line-height:19px;height:20px;cursor:pointer;text-align:center;background-color:#000}.dg.main .close-button.close-top{position:relative}.dg.main .close-button.close-bottom{position:absolute}.dg.main .close-button:hover{background-color:#111}.dg.a{float:right;margin-right:15px;overflow-y:visible}.dg.a.has-save>ul.close-top{margin-top:0}.dg.a.has-save>ul.close-bottom{margin-top:27px}.dg.a.has-save>ul.closed{margin-top:0}.dg.a .save-row{top:0;z-index:1002}.dg.a .save-row.close-top{position:relative}.dg.a .save-row.close-bottom{position:fixed}.dg li{-webkit-transition:height .1s ease-out;-o-transition:height .1s ease-out;-moz-transition:height .1s ease-out;transition:height .1s ease-out;-webkit-transition:overflow .1s linear;-o-transition:overflow .1s linear;-moz-transition:overflow .1s linear;transition:overflow .1s linear}.dg li:not(.folder){cursor:auto;height:27px;line-height:27px;padding:0 4px 0 5px}.dg li.folder{padding:0;border-left:4px solid rgba(0,0,0,0)}.dg li.title{cursor:pointer;margin-left:-4px}.dg .closed li:not(.title),.dg .closed ul li,.dg .closed ul li>*{height:0;overflow:hidden;border:0}.dg .cr{clear:both;padding-left:3px;height:27px;overflow:hidden}.dg .property-name{cursor:default;float:left;clear:left;width:40%;overflow:hidden;text-overflow:ellipsis}.dg .cr.function .property-name{width:100%}.dg .c{float:left;width:60%;position:relative}.dg .c input[type=text]{border:0;margin-top:4px;padding:3px;width:100%;float:right}.dg .has-slider input[type=text]{width:30%;margin-left:0}.dg .slider{float:left;width:66%;margin-left:-5px;margin-right:0;height:19px;margin-top:4px}.dg .slider-fg{height:100%}.dg .c input[type=checkbox]{margin-top:7px}.dg .c select{margin-top:5px}.dg .cr.function,.dg .cr.function .property-name,.dg .cr.function *,.dg .cr.boolean,.dg .cr.boolean *{cursor:pointer}.dg .cr.color{overflow:visible}.dg .selector{display:none;position:absolute;margin-left:-9px;margin-top:23px;z-index:10}.dg .c:hover .selector,.dg .selector.drag{display:block}.dg li.save-row{padding:0}.dg li.save-row .button{display:inline-block;padding:0px 6px}.dg.dialogue{background-color:#222;width:460px;padding:15px;font-size:13px;line-height:15px}#dg-new-constructor{padding:10px;color:#222;font-family:Monaco, monospace;font-size:10px;border:0;resize:none;box-shadow:inset 1px 1px 1px #888;word-wrap:break-word;margin:12px 0;display:block;width:440px;overflow-y:scroll;height:100px;position:relative}#dg-local-explain{display:none;font-size:11px;line-height:17px;border-radius:3px;background-color:#333;padding:8px;margin-top:10px}#dg-local-explain code{font-size:10px}#dat-gui-save-locally{display:none}.dg{color:#eee;font:11px 'Lucida Grande', sans-serif;text-shadow:0 -1px 0 #111}.dg.main::-webkit-scrollbar{width:5px;background:#1a1a1a}.dg.main::-webkit-scrollbar-corner{height:0;display:none}.dg.main::-webkit-scrollbar-thumb{border-radius:5px;background:#676767}.dg li:not(.folder){background:#1a1a1a;border-bottom:1px solid #2c2c2c}.dg li.save-row{line-height:25px;background:#dad5cb;border:0}.dg li.save-row select{margin-left:5px;width:108px}.dg li.save-row .button{margin-left:5px;margin-top:1px;border-radius:2px;font-size:9px;line-height:7px;padding:4px 4px 5px 4px;background:#c5bdad;color:#fff;text-shadow:0 1px 0 #b0a58f;box-shadow:0 -1px 0 #b0a58f;cursor:pointer}.dg li.save-row .button.gears{background:#c5bdad url(data:image/png;base64,) 2px 1px no-repeat;height:7px;width:8px}.dg li.save-row .button:hover{background-color:#bab19e;box-shadow:0 -1px 0 #b0a58f}.dg li.folder{border-bottom:0}.dg li.title{padding-left:16px;background:#000 url(data:image/gif;base64,R0lGODlhBQAFAJEAAP////Pz8////////yH5BAEAAAIALAAAAAAFAAUAAAIIlI+hKgFxoCgAOw==) 6px 10px no-repeat;cursor:pointer;border-bottom:1px solid rgba(255,255,255,0.2)}.dg .closed li.title{background-image:url(data:image/gif;base64,R0lGODlhBQAFAJEAAP////Pz8////////yH5BAEAAAIALAAAAAAFAAUAAAIIlGIWqMCbWAEAOw==)}.dg .cr.boolean{border-left:3px solid #806787}.dg .cr.color{border-left:3px solid}.dg .cr.function{border-left:3px solid #e61d5f}.dg .cr.number{border-left:3px solid #2FA1D6}.dg .cr.number input[type=text]{color:#2FA1D6}.dg .cr.string{border-left:3px solid #1ed36f}.dg .cr.string input[type=text]{color:#1ed36f}.dg .cr.function:hover,.dg .cr.boolean:hover{background:#111}.dg .c input[type=text]{background:#303030;outline:none}.dg .c input[type=text]:hover{background:#3c3c3c}.dg .c input[type=text]:focus{background:#494949;color:#fff}.dg .c .slider{background:#303030;cursor:ew-resize}.dg .c .slider-fg{background:#2FA1D6;max-width:100%}.dg .c .slider:hover{background:#3c3c3c}.dg .c .slider:hover .slider-fg{background:#44abda}
`);ed.inject(ad);var ws="dg",Es=72,Ms=20,Mr="Default",yr=function(){try{return!!window.localStorage}catch{return!1}}(),wr=void 0,Ss=!0,Cn=void 0,Li=!1,Bs=[],ge=function t(e){var n=this,r=e||{};this.domElement=document.createElement("div"),this.__ul=document.createElement("ul"),this.domElement.appendChild(this.__ul),M.addClass(this.domElement,ws),this.__folders={},this.__controllers=[],this.__rememberedObjects=[],this.__rememberedObjectIndecesToControllers=[],this.__listening=[],r=I.defaults(r,{closeOnTop:!1,autoPlace:!0,width:t.DEFAULT_WIDTH}),r=I.defaults(r,{resizable:r.autoPlace,hideable:r.autoPlace}),I.isUndefined(r.load)?r.load={preset:Mr}:r.preset&&(r.load.preset=r.preset),I.isUndefined(r.parent)&&r.hideable&&Bs.push(this),r.resizable=I.isUndefined(r.parent)&&r.resizable,r.autoPlace&&I.isUndefined(r.scrollable)&&(r.scrollable=!0);var o=yr&&localStorage.getItem(Bn(this,"isLocal"))==="true",i=void 0,l=void 0;if(Object.defineProperties(this,{parent:{get:function(){return r.parent}},scrollable:{get:function(){return r.scrollable}},autoPlace:{get:function(){return r.autoPlace}},closeOnTop:{get:function(){return r.closeOnTop}},preset:{get:function(){return n.parent?n.getRoot().preset:r.load.preset},set:function(x){n.parent?n.getRoot().preset=x:r.load.preset=x,cd(this),n.revert()}},width:{get:function(){return r.width},set:function(x){r.width=x,Hi(n,x)}},name:{get:function(){return r.name},set:function(x){r.name=x,l&&(l.innerHTML=r.name)}},closed:{get:function(){return r.closed},set:function(x){r.closed=x,r.closed?M.addClass(n.__ul,t.CLASS_CLOSED):M.removeClass(n.__ul,t.CLASS_CLOSED),this.onResize(),n.__closeButton&&(n.__closeButton.innerHTML=x?t.TEXT_OPEN:t.TEXT_CLOSED)}},load:{get:function(){return r.load}},useLocalStorage:{get:function(){return o},set:function(x){yr&&(o=x,x?M.bind(window,"unload",i):M.unbind(window,"unload",i),localStorage.setItem(Bn(n,"isLocal"),x))}}}),I.isUndefined(r.parent)){if(this.closed=r.closed||!1,M.addClass(this.domElement,t.CLASS_MAIN),M.makeSelectable(this.domElement,!1),yr&&o){n.useLocalStorage=!0;var c=localStorage.getItem(Bn(this,"gui"));c&&(r.load=JSON.parse(c))}this.__closeButton=document.createElement("div"),this.__closeButton.innerHTML=t.TEXT_CLOSED,M.addClass(this.__closeButton,t.CLASS_CLOSE_BUTTON),r.closeOnTop?(M.addClass(this.__closeButton,t.CLASS_CLOSE_TOP),this.domElement.insertBefore(this.__closeButton,this.domElement.childNodes[0])):(M.addClass(this.__closeButton,t.CLASS_CLOSE_BOTTOM),this.domElement.appendChild(this.__closeButton)),M.bind(this.__closeButton,"click",function(){n.closed=!n.closed})}else{r.closed===void 0&&(r.closed=!0);var m=document.createTextNode(r.name);M.addClass(m,"controller-name"),l=Yi(n,m);var h=function(x){return x.preventDefault(),n.closed=!n.closed,!1};M.addClass(this.__ul,t.CLASS_CLOSED),M.addClass(l,"title"),M.bind(l,"click",h),r.closed||(this.closed=!1)}r.autoPlace&&(I.isUndefined(r.parent)&&(Ss&&(Cn=document.createElement("div"),M.addClass(Cn,ws),M.addClass(Cn,t.CLASS_AUTO_PLACE_CONTAINER),document.body.appendChild(Cn),Ss=!1),Cn.appendChild(this.domElement),M.addClass(this.domElement,t.CLASS_AUTO_PLACE)),this.parent||Hi(n,r.width)),this.__resizeHandler=function(){n.onResizeDebounced()},M.bind(window,"resize",this.__resizeHandler),M.bind(this.__ul,"webkitTransitionEnd",this.__resizeHandler),M.bind(this.__ul,"transitionend",this.__resizeHandler),M.bind(this.__ul,"oTransitionEnd",this.__resizeHandler),this.onResize(),r.resizable&&ud(this),i=function(){yr&&localStorage.getItem(Bn(n,"isLocal"))==="true"&&localStorage.setItem(Bn(n,"gui"),JSON.stringify(n.getSaveObject()))},this.saveToLocalStorageIfPossible=i;function g(){var _=n.getRoot();_.width+=1,I.defer(function(){_.width-=1})}r.parent||g()};ge.toggleHide=function(){Li=!Li,I.each(Bs,function(t){t.domElement.style.display=Li?"none":""})};ge.CLASS_AUTO_PLACE="a";ge.CLASS_AUTO_PLACE_CONTAINER="ac";ge.CLASS_MAIN="main";ge.CLASS_CONTROLLER_ROW="cr";ge.CLASS_TOO_TALL="taller-than-window";ge.CLASS_CLOSED="closed";ge.CLASS_CLOSE_BUTTON="close-button";ge.CLASS_CLOSE_TOP="close-top";ge.CLASS_CLOSE_BOTTOM="close-bottom";ge.CLASS_DRAG="drag";ge.DEFAULT_WIDTH=245;ge.TEXT_CLOSED="Close Controls";ge.TEXT_OPEN="Open Controls";ge._keydownHandler=function(t){document.activeElement.type!=="text"&&(t.which===Es||t.keyCode===Es)&&ge.toggleHide()};M.bind(window,"keydown",ge._keydownHandler,!1);I.extend(ge.prototype,{add:function(e,n){return Er(this,e,n,{factoryArgs:Array.prototype.slice.call(arguments,2)})},addColor:function(e,n){return Er(this,e,n,{color:!0})},remove:function(e){this.__ul.removeChild(e.__li),this.__controllers.splice(this.__controllers.indexOf(e),1);var n=this;I.defer(function(){n.onResize()})},destroy:function(){if(this.parent)throw new Error("Only the root GUI should be removed with .destroy(). For subfolders, use gui.removeFolder(folder) instead.");this.autoPlace&&Cn.removeChild(this.domElement);var e=this;I.each(this.__folders,function(n){e.removeFolder(n)}),M.unbind(window,"keydown",ge._keydownHandler,!1),Ps(this)},addFolder:function(e){if(this.__folders[e]!==void 0)throw new Error('You already have a folder in this GUI by the name "'+e+'"');var n={name:e,parent:this};n.autoPlace=this.autoPlace,this.load&&this.load.folders&&this.load.folders[e]&&(n.closed=this.load.folders[e].closed,n.load=this.load.folders[e]);var r=new ge(n);this.__folders[e]=r;var o=Yi(this,r.domElement);return M.addClass(o,"folder"),r},removeFolder:function(e){this.__ul.removeChild(e.domElement.parentElement),delete this.__folders[e.name],this.load&&this.load.folders&&this.load.folders[e.name]&&delete this.load.folders[e.name],Ps(e);var n=this;I.each(e.__folders,function(r){e.removeFolder(r)}),I.defer(function(){n.onResize()})},open:function(){this.closed=!1},close:function(){this.closed=!0},hide:function(){this.domElement.style.display="none"},show:function(){this.domElement.style.display=""},onResize:function(){var e=this.getRoot();if(e.scrollable){var n=M.getOffset(e.__ul).top,r=0;I.each(e.__ul.childNodes,function(o){e.autoPlace&&o===e.__save_row||(r+=M.getHeight(o))}),window.innerHeight-n-Ms<r?(M.addClass(e.domElement,ge.CLASS_TOO_TALL),e.__ul.style.height=window.innerHeight-n-Ms+"px"):(M.removeClass(e.domElement,ge.CLASS_TOO_TALL),e.__ul.style.height="auto")}e.__resize_handle&&I.defer(function(){e.__resize_handle.style.height=e.__ul.offsetHeight+"px"}),e.__closeButton&&(e.__closeButton.style.width=e.width+"px")},onResizeDebounced:I.debounce(function(){this.onResize()},50),remember:function(){if(I.isUndefined(wr)&&(wr=new id,wr.domElement.innerHTML=td),this.parent)throw new Error("You can only call remember on a top level GUI.");var e=this;I.each(Array.prototype.slice.call(arguments),function(n){e.__rememberedObjects.length===0&&ld(e),e.__rememberedObjects.indexOf(n)===-1&&e.__rememberedObjects.push(n)}),this.autoPlace&&Hi(this,this.width)},getRoot:function(){for(var e=this;e.parent;)e=e.parent;return e},getSaveObject:function(){var e=this.load;return e.closed=this.closed,this.__rememberedObjects.length>0&&(e.preset=this.preset,e.remembered||(e.remembered={}),e.remembered[this.preset]=Jr(this)),e.folders={},I.each(this.__folders,function(n,r){e.folders[r]=n.getSaveObject()}),e},save:function(){this.load.remembered||(this.load.remembered={}),this.load.remembered[this.preset]=Jr(this),Vi(this,!1),this.saveToLocalStorageIfPossible()},saveAs:function(e){this.load.remembered||(this.load.remembered={},this.load.remembered[Mr]=Jr(this,!0)),this.load.remembered[e]=Jr(this),this.preset=e,$i(this,e,!0),this.saveToLocalStorageIfPossible()},revert:function(e){I.each(this.__controllers,function(n){this.getRoot().load.remembered?Ds(e||this.getRoot(),n):n.setValue(n.initialValue),n.__onFinishChange&&n.__onFinishChange.call(n,n.getValue())},this),I.each(this.__folders,function(n){n.revert(n)}),e||Vi(this.getRoot(),!1)},listen:function(e){var n=this.__listening.length===0;this.__listening.push(e),n&&Os(this.__listening)},updateDisplay:function(){I.each(this.__controllers,function(e){e.updateDisplay()}),I.each(this.__folders,function(e){e.updateDisplay()})}});function Yi(t,e,n){var r=document.createElement("li");return e&&r.appendChild(e),n?t.__ul.insertBefore(r,n):t.__ul.appendChild(r),t.onResize(),r}function Ps(t){M.unbind(window,"resize",t.__resizeHandler),t.saveToLocalStorageIfPossible&&M.unbind(window,"unload",t.saveToLocalStorageIfPossible)}function Vi(t,e){var n=t.__preset_select[t.__preset_select.selectedIndex];e?n.innerHTML=n.value+"*":n.innerHTML=n.value}function sd(t,e,n){if(n.__li=e,n.__gui=t,I.extend(n,{options:function(l){if(arguments.length>1){var c=n.__li.nextElementSibling;return n.remove(),Er(t,n.object,n.property,{before:c,factoryArgs:[I.toArray(arguments)]})}if(I.isArray(l)||I.isObject(l)){var m=n.__li.nextElementSibling;return n.remove(),Er(t,n.object,n.property,{before:m,factoryArgs:[l]})}},name:function(l){return n.__li.firstElementChild.firstElementChild.innerHTML=l,n},listen:function(){return n.__gui.listen(n),n},remove:function(){return n.__gui.remove(n),n}}),n instanceof Gi){var r=new Qr(n.object,n.property,{min:n.__min,max:n.__max,step:n.__step});I.each(["updateDisplay","onChange","onFinishChange","step","min","max"],function(i){var l=n[i],c=r[i];n[i]=r[i]=function(){var m=Array.prototype.slice.call(arguments);return c.apply(r,m),l.apply(n,m)}}),M.addClass(e,"has-slider"),n.domElement.insertBefore(r.domElement,n.domElement.firstElementChild)}else if(n instanceof Qr){var o=function(l){if(I.isNumber(n.__min)&&I.isNumber(n.__max)){var c=n.__li.firstElementChild.firstElementChild.innerHTML,m=n.__gui.__listening.indexOf(n)>-1;n.remove();var h=Er(t,n.object,n.property,{before:n.__li.nextElementSibling,factoryArgs:[n.__min,n.__max,n.__step]});return h.name(c),m&&h.listen(),h}return l};n.min=I.compose(o,n.min),n.max=I.compose(o,n.max)}else n instanceof Is?(M.bind(e,"click",function(){M.fakeEvent(n.__checkbox,"click")}),M.bind(n.__checkbox,"click",function(i){i.stopPropagation()})):n instanceof Cs?(M.bind(e,"click",function(){M.fakeEvent(n.__button,"click")}),M.bind(e,"mouseover",function(){M.addClass(n.__button,"hover")}),M.bind(e,"mouseout",function(){M.removeClass(n.__button,"hover")})):n instanceof zi&&(M.addClass(e,"color"),n.updateDisplay=I.compose(function(i){return e.style.borderLeftColor=n.__color.toString(),i},n.updateDisplay),n.updateDisplay());n.setValue=I.compose(function(i){return t.getRoot().__preset_select&&n.isModified()&&Vi(t.getRoot(),!0),i},n.setValue)}function Ds(t,e){var n=t.getRoot(),r=n.__rememberedObjects.indexOf(e.object);if(r!==-1){var o=n.__rememberedObjectIndecesToControllers[r];if(o===void 0&&(o={},n.__rememberedObjectIndecesToControllers[r]=o),o[e.property]=e,n.load&&n.load.remembered){var i=n.load.remembered,l=void 0;if(i[t.preset])l=i[t.preset];else if(i[Mr])l=i[Mr];else return;if(l[r]&&l[r][e.property]!==void 0){var c=l[r][e.property];e.initialValue=c,e.setValue(c)}}}}function Er(t,e,n,r){if(e[n]===void 0)throw new Error('Object "'+e+'" has no property "'+n+'"');var o=void 0;if(r.color)o=new zi(e,n);else{var i=[e,n].concat(r.factoryArgs);o=nd.apply(t,i)}r.before instanceof _n&&(r.before=r.before.__li),Ds(t,o),M.addClass(o.domElement,"c");var l=document.createElement("span");M.addClass(l,"property-name"),l.innerHTML=o.property;var c=document.createElement("div");c.appendChild(l),c.appendChild(o.domElement);var m=Yi(t,c,r.before);return M.addClass(m,ge.CLASS_CONTROLLER_ROW),o instanceof zi?M.addClass(m,"color"):M.addClass(m,Wf(o.getValue())),sd(t,m,o),t.__controllers.push(o),o}function Bn(t,e){return document.location.href+"."+e}function $i(t,e,n){var r=document.createElement("option");r.innerHTML=e,r.value=e,t.__preset_select.appendChild(r),n&&(t.__preset_select.selectedIndex=t.__preset_select.length-1)}function Ts(t,e){e.style.display=t.useLocalStorage?"block":"none"}function ld(t){var e=t.__save_row=document.createElement("li");M.addClass(t.domElement,"has-save"),t.__ul.insertBefore(e,t.__ul.firstChild),M.addClass(e,"save-row");var n=document.createElement("span");n.innerHTML="&nbsp;",M.addClass(n,"button gears");var r=document.createElement("span");r.innerHTML="Save",M.addClass(r,"button"),M.addClass(r,"save");var o=document.createElement("span");o.innerHTML="New",M.addClass(o,"button"),M.addClass(o,"save-as");var i=document.createElement("span");i.innerHTML="Revert",M.addClass(i,"button"),M.addClass(i,"revert");var l=t.__preset_select=document.createElement("select");if(t.load&&t.load.remembered?I.each(t.load.remembered,function(_,x){$i(t,x,x===t.preset)}):$i(t,Mr,!1),M.bind(l,"change",function(){for(var _=0;_<t.__preset_select.length;_++)t.__preset_select[_].innerHTML=t.__preset_select[_].value;t.preset=this.value}),e.appendChild(l),e.appendChild(n),e.appendChild(r),e.appendChild(o),e.appendChild(i),yr){var c=document.getElementById("dg-local-explain"),m=document.getElementById("dg-local-storage"),h=document.getElementById("dg-save-locally");h.style.display="block",localStorage.getItem(Bn(t,"isLocal"))==="true"&&m.setAttribute("checked","checked"),Ts(t,c),M.bind(m,"change",function(){t.useLocalStorage=!t.useLocalStorage,Ts(t,c)})}var g=document.getElementById("dg-new-constructor");M.bind(g,"keydown",function(_){_.metaKey&&(_.which===67||_.keyCode===67)&&wr.hide()}),M.bind(n,"click",function(){g.innerHTML=JSON.stringify(t.getSaveObject(),void 0,2),wr.show(),g.focus(),g.select()}),M.bind(r,"click",function(){t.save()}),M.bind(o,"click",function(){var _=prompt("Enter a new preset name.");_&&t.saveAs(_)}),M.bind(i,"click",function(){t.revert()})}function ud(t){var e=void 0;t.__resize_handle=document.createElement("div"),I.extend(t.__resize_handle.style,{width:"6px",marginLeft:"-3px",height:"200px",cursor:"ew-resize",position:"absolute"});function n(i){return i.preventDefault(),t.width+=e-i.clientX,t.onResize(),e=i.clientX,!1}function r(){M.removeClass(t.__closeButton,ge.CLASS_DRAG),M.unbind(window,"mousemove",n),M.unbind(window,"mouseup",r)}function o(i){return i.preventDefault(),e=i.clientX,M.addClass(t.__closeButton,ge.CLASS_DRAG),M.bind(window,"mousemove",n),M.bind(window,"mouseup",r),!1}M.bind(t.__resize_handle,"mousedown",o),M.bind(t.__closeButton,"mousedown",o),t.domElement.insertBefore(t.__resize_handle,t.domElement.firstElementChild)}function Hi(t,e){t.domElement.style.width=e+"px",t.__save_row&&t.autoPlace&&(t.__save_row.style.width=e+"px"),t.__closeButton&&(t.__closeButton.style.width=e+"px")}function Jr(t,e){var n={};return I.each(t.__rememberedObjects,function(r,o){var i={},l=t.__rememberedObjectIndecesToControllers[o];I.each(l,function(c,m){i[m]=e?c.initialValue:c.getValue()}),n[o]=i}),n}function cd(t){for(var e=0;e<t.__preset_select.length;e++)t.__preset_select[e].value===t.preset&&(t.__preset_select.selectedIndex=e)}function Os(t){t.length!==0&&od.call(window,function(){Os(t)}),I.each(t,function(e){e.updateDisplay()})}var Ns=ge;function gn(t){return[t.debugMeshes,t.naniteObjects[0]]}var eo=(t,e)=>e.diffuseTextureView||t.fallbackDiffuseTextureView;var dd=1024,On=2,md=dd*On,$e=()=>performance.now(),Sr=t=>$e()-t,to=class{_profileThisFrame=!1;hasRequiredFeature;queryPool;queryInProgressBuffer;resultsBuffer;currentFrameScopes=[];get enabled(){return this._profileThisFrame&&this.hasRequiredFeature}constructor(e){if(this.hasRequiredFeature=e.features.has("timestamp-query"),!this.hasRequiredFeature){this.queryPool=void 0,this.queryInProgressBuffer=void 0,this.resultsBuffer=void 0;return}this.queryPool=e.createQuerySet({type:"timestamp",count:md}),this.queryInProgressBuffer=e.createBuffer({label:"profiler-in-progress",size:this.queryPool.count*ns,usage:GPUBufferUsage.QUERY_RESOLVE|GPUBufferUsage.COPY_SRC}),this.resultsBuffer=e.createBuffer({label:"profiler-results",size:this.queryInProgressBuffer.size,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ})}profileNextFrame(e){this._profileThisFrame=e}beginFrame(){for(;this.currentFrameScopes.length>0;)this.currentFrameScopes.pop()}endFrame(e){if(!this.enabled)return;let n=this.currentFrameScopes.length*On;e.resolveQuerySet(this.queryPool,0,n,this.queryInProgressBuffer,0),this.resultsBuffer.mapState==="unmapped"&&e.copyBufferToBuffer(this.queryInProgressBuffer,0,this.resultsBuffer,0,this.resultsBuffer.size)}async scheduleRaportIfNeededAsync(e){if(!this.enabled||this.currentFrameScopes.length==0){this._profileThisFrame=!1;return}this._profileThisFrame=!1;let n=this.currentFrameScopes.slice();if(this.resultsBuffer.mapState==="unmapped"){await this.resultsBuffer.mapAsync(GPUMapMode.READ);let r=new BigInt64Array(this.resultsBuffer.getMappedRange()),o=n.map(([i,l,c],m)=>{let h=0;if(l==="gpu"){let g=r[m*On],_=r[m*On+1];h=Number(_-g)*as}else h=c;return[i,h]});this.resultsBuffer.unmap(),e?.(o)}}createScopeGpu(e){if(!this.enabled)return;let n=this.currentFrameScopes.length;return this.currentFrameScopes.push([e,"gpu",0]),{querySet:this.queryPool,beginningOfPassWriteIndex:n*On,endOfPassWriteIndex:n*On+1}}startRegionCpu(e){if(!this.enabled)return;let n=this.currentFrameScopes.length,r=performance.now();return this.currentFrameScopes.push([e,"cpu",r]),n}endRegionCpu(e){if(!this.enabled||e===void 0)return;let n=this.currentFrameScopes[e];if(n){let[r,o,i]=n;n[2]=Sr(i)}}};var pd={fps:{hideLabel:!0},ms:{hideLabel:!0},"Camera pos WS":{},"Camera rot":{},s0:{categoryName:"Memory"},"Index buffer":{},"Meshlets data":{visibilityDevice:"gpu"},"Instance tfxs":{visibilityDevice:"gpu"},"Drawn instances":{visibilityDevice:"gpu"},"Drawn impostors":{visibilityDevice:"gpu"},"Drawn meshlets":{visibilityDevice:"gpu"},s1:{categoryName:"Geometry"},Preprocessing:{},"Scene meshlets":{},"Scene triangles":{},"Rendered impostors":{visibilityDevice:"gpu"},"Rendered meshlets":{},"Rendered triangles":{},"HW: Rendered meshlets":{visibilityDevice:"gpu"},"HW: Rendered triangles":{visibilityDevice:"gpu"},"SW: Rendered meshlets":{visibilityDevice:"gpu"},"SW: Rendered triangles":{visibilityDevice:"gpu"}},Us=.95,hd=1e3,qi=class{values={};lastRenderedValues={};frameStart=0;deltaTimeMS=0;deltaTimeSmoothMS=void 0;parentEl;lastDOMUpdate=0;constructor(){window&&window.document?(this.parentEl=window.document.getElementById("stats-window"),this.frameStart=$e(),this.lastDOMUpdate=this.frameStart):this.parentEl=void 0}update(e,n){this.values[e]=n}show=()=>Nt(this.parentEl);onBeginFrame=()=>{this.frameStart=$e()};onEndFrame=()=>{let e=$e();this.deltaTimeMS=e-this.frameStart,this.deltaTimeSmoothMS===void 0?this.deltaTimeSmoothMS=this.deltaTimeMS:this.deltaTimeSmoothMS=this.deltaTimeSmoothMS*Us+this.deltaTimeMS*(1-Us);let n=1/this.deltaTimeMS*1e3;this.update("fps",`${n.toFixed(2)} fps`),this.update("ms",`${this.deltaTimeMS.toFixed(2)}ms`),e-this.lastDOMUpdate>hd&&(this.lastDOMUpdate=e,setTimeout(this.renderStats,0))};renderStats=()=>{let e=Array.from(this.parentEl.children);Object.entries(pd).forEach(([n,r])=>{let o=n,i=this.getStatsHtmlEl(e,o,r);if(r.categoryName){i.textContent!==r.categoryName&&(i.innerHTML=r.categoryName),i.classList.add("stats-category-name");return}if(!this.checkVisibility(r,i))return;let l=this.values[o],c=this.lastRenderedValues[o];if(l==c)return;let m=`${o}: ${l}`;r.hideLabel&&(m=String(l)),i.innerHTML=m}),this.lastRenderedValues={...this.values}};getStatsHtmlEl=(e,n,r)=>{let o="data-stats-attr";if(r.el)return r.el;let i=e.find(l=>l.getAttribute(o)===n);return i||(i=document.createElement("p"),i.setAttribute(o,n),this.parentEl.appendChild(i)),r.el=i,i};checkVisibility(e,n){if(!e.visibilityDevice)return!0;let r=e.visibilityDevice===P.nanite.render.naniteDevice;return this.setElVisible(n,r),r}setElVisible(e,n){n&&!qr(e)&&(Nt(e),this.lastRenderedValues={}),!n&&qr(e)&&(In(e),this.lastRenderedValues={})}},ne=new qi;var Ut=(t,e="")=>`${t.NAME}${e?"-"+e:""}`,be=t=>`${t.NAME}-shader`,ve=(t,e="")=>`${Ut(t,e)}-pipeline`,_d=(t,e="")=>`${Ut(t,e)}-uniforms`,Le=()=>P.useAlternativeClearColor?P.clearColorAlt:P.clearColor,yt={cullMode:P.nanite.render.allowHardwareBackfaceCull?"back":"none",topology:"triangle-list",stripIndexFormat:void 0},Ze={depthWriteEnabled:!0,depthCompare:"less",format:Tn},xe=(t,e,n,r,o)=>{let i=r.getBindGroupLayout(0);return n.createBindGroup({label:_d(t,e),layout:i,entries:o})},no=(t,e,n,r)=>xe(t,"",e,n,r),Oe=(t,e,n="clear")=>({view:t,loadOp:n,storeOp:"store",clearValue:[e[0],e[1],e[2],e[3]===void 0?1:e[3]]}),je=(t,e="clear")=>({view:t,depthClearValue:1,depthLoadOp:e,depthStoreOp:"store"}),Me=class{cache={};getBindings(e,n){let r=this.cache[e];if(r)return r;let o=n();return this.cache[e]=o,o}clear(){this.cache={}}};function Fs(){ne.update("Rendered meshlets","-"),ne.update("Rendered triangles","-"),ne.update("HW: Rendered meshlets","-"),ne.update("HW: Rendered triangles","-"),ne.update("SW: Rendered meshlets","-"),ne.update("SW: Rendered triangles","-"),ne.update("Rendered impostors","-")}function ro(t,e,n){ne.update("Rendered meshlets",mt(e,t.naiveMeshletCount)),ne.update("Rendered triangles",mt(n,t.naiveTriangleCount))}function Ls(t,e,n,r){let o=t+n,i=e+r;ne.update("HW: Rendered meshlets",mt(t,o)),ne.update("HW: Rendered triangles",mt(e,i)),ne.update("SW: Rendered meshlets",mt(n,o)),ne.update("SW: Rendered triangles",mt(r,i))}function ks(t,e){ne.update("Rendered impostors",mt(t,e))}var Gs=14,Ki;function zs(t,e,n){let r,o,i,l=new Ns,c={openGithub:()=>{window.location.href=P.githubRepoLink},profile:()=>{t.profileNextFrame(!0)},resetCamera:()=>{n.resetPosition()},getGpuDrawStats:()=>{P.nanite.render.nextFrameDebugDrawnMeshletsBuffer=!0},showSwRasterAlert:()=>{alert("WebGPU does not support atomic<u64> yet. I can't output both depth and color data with just 32 bits. Depth and normals are the best we get. And even that is a squeeze. What you see is the default white color affected by lights.")}};l.add(c,"openGithub").name("GITHUB"),l.add(c,"profile").name("Profile");let m=l.add(c,"getGpuDrawStats").name("Get GPU stats");g(),_(),x(),T(),S(),h();function h(){let E=P.nanite.render.naniteDevice;Fs(),Nn(m,E=="gpu"),Nn(r,E=="gpu"),Nn(i,E=="gpu")}function g(){let E=l.addFolder("Nanite");E.open();let R=Xi(P.nanite.render,"naniteDevice",[{label:"GPU",value:"gpu"},{label:"CPU",value:"cpu"}]);E.add(R,"naniteDevice",R.values).name("Nanite device").onFinishChange(h),E.add(P.nanite.render,"errorThreshold",0,10).name("Error threshold");let C=Xi(P.nanite.render,"shadingMode",[{label:"Shaded",value:hr},{label:"Normals",value:vt},{label:"Triangles",value:Vr},{label:"Meshlets",value:$r},{label:"LOD levels",value:Hr},{label:"HW/SW/Impostor",value:zt}]);o=E.add(C,"shadingMode",C.values).name("Shading mode"),r=E.add(P.nanite.render,"freezeGPU_Visibilty").name("Freeze culling"),E.add(c,"showSwRasterAlert").name("Software rasterizer - README");let N=P.softwareRasterizer;E.add(N,"enabled").name("Softw. raster. enable"),i=E.add(N,"threshold",0,2500).name("Softw. raster. threshold [px]")}function _(){let E=l.addFolder("Instances culling");E.open();let R=P.cullingInstances,C=P.impostors;E.add(R,"enabled").name("Enabled"),E.add(R,"frustumCulling").name("Frustum culling"),E.add(R,"occlusionCulling").name("Occlusion culling"),E.add(C,"billboardThreshold",0,8e3).name("Billboard threshold [px]"),E.add(C,"forceOnlyBillboards").name("Force billboards"),E.add(C,"ditherStrength",0,1).name("Billboard dither")}function x(){let E=l.addFolder("Meshlet culling");E.open();let R=P.cullingMeshlets,C=P.nanite.render;E.add(R,"frustumCulling").name("Frustum culling"),E.add(R,"occlusionCulling").name("Occlusion culling"),E.add(C,"isOverrideOcclusionCullMipmap").name("OC override"),E.add(C,"occlusionCullOverrideMipmapLevel",0,Gs).step(1).name("OC ov-ride lvl")}function T(){let E=l.addFolder("Color mgmt"),R=P.colors;E.add(R,"gamma",1,3).name("Gamma"),E.add(R,"exposure",0,2).name("Exposure"),E.add(R,"ditherStrength",0,2).name("Dithering")}function S(){let E=l.addFolder("DEBUG");E.open(),w(E,P,"clearColor","Bg color"),E.add(P,"useAlternativeClearColor").name("Alt. bg"),E.add(P,"drawGround").name("Draw ground");let R=Xi(P,"displayMode",[{label:"Nanite",value:"nanite"},{label:"DBG: lod",value:"dbg-lod"},{label:"DBG: lod meshlets",value:"dbg-lod-meshlets"},{label:"DBG: nanite meshlets",value:"dbg-nanite-meshlets"},{label:"DBG: depth pyramid",value:"dbg-depth-pyramid"}]),C=E.add(R,"displayMode",R.values).name("Display mode");Ki=B=>{P.displayMode=B,C.__onFinishChange(),C.updateDisplay()};let[N,L]=gn(e),D=N.meshoptimizerLODs.length-1,H=E.add(P,"dbgMeshoptimizerLodLevel",0,D).step(1).name("LOD level");D=L.lodLevelCount-1;let J=E.add(P,"dbgNaniteLodLevel",0,D).step(1).name("Nanite LOD"),re=E.add(P,"dbgDepthPyramidLevel",0,Gs).step(1).name("Pyramid level");C.onFinishChange(oe),E.add(c,"resetCamera").name("Reset camera"),oe();function oe(){P.nanite.render.hasValidDepthPyramid=!1;let B=P.displayMode,ee=["dbg-lod","dbg-lod-meshlets"].includes(B);Nn(H,ee),Nn(J,B==="dbg-nanite-meshlets"),Nn(re,B==="dbg-depth-pyramid")}}function w(E,R,C,N){let L={value:[]};Object.defineProperty(L,"value",{enumerable:!0,get:()=>{let D=R[C];return[D[0]*255,D[1]*255,D[2]*255]},set:D=>{let H=R[C];H[0]=D[0]/255,H[1]=D[1]/255,H[2]=D[2]/255}}),E.addColor(L,"value").name(N)}}function Nn(t,e){if(!t){console.error("Not controller for gui element found!");return}let n=t.__li;e?n.style.display="":n.style.display="none"}var Xi=(t,e,n)=>{let r={values:n.map(o=>o.label)};return Object.defineProperty(r,e,{enumerable:!0,get:()=>{let o=t[e];return(n.find(l=>l.value===o)||n[0]).label},set:o=>{let i=n.find(l=>l.label===o)||n[0];t[e]=i.value}}),r};function Vs(t){console.log("Profiler:",t);let e=document.getElementById("profiler-results");e.innerHTML="",Nt(e.parentNode);let n={},r=new Set;t.forEach(([o,i])=>{let l=n[o]||0;n[o]=l+i,r.add(o)}),r.forEach(o=>{let i=n[o],l=document.createElement("li");l.innerHTML=`${o}: ${i.toFixed(2)}ms`,e.appendChild(l)})}var qt={CAMERA_FORWARD:"w",CAMERA_BACK:"s",CAMERA_LEFT:"a",CAMERA_RIGHT:"d",CAMERA_UP:" ",CAMERA_DOWN:"z",CAMERA_GO_FASTER:"shift",DEBUG_DEPTH:"e"},gd=()=>({directions:{forward:!1,backward:!1,left:!1,right:!1,up:!1,down:!1,goFaster:!1},mouse:{x:0,y:0,zoom:0,touching:!1}});function $s(t,e){let{directions:n,mouse:r}=gd(),o=(i,l)=>{switch(i.key.toLowerCase()){case qt.CAMERA_FORWARD:n.forward=l,i.preventDefault(),i.stopPropagation();break;case qt.CAMERA_BACK:n.backward=l,i.preventDefault(),i.stopPropagation();break;case qt.CAMERA_LEFT:n.left=l,i.preventDefault(),i.stopPropagation();break;case qt.CAMERA_RIGHT:n.right=l,i.preventDefault(),i.stopPropagation();break;case qt.CAMERA_UP:n.up=l,i.preventDefault(),i.stopPropagation();break;case qt.CAMERA_DOWN:n.down=l,i.preventDefault(),i.stopPropagation();break;case qt.CAMERA_GO_FASTER:n.goFaster=l,i.preventDefault(),i.stopPropagation();break;case qt.DEBUG_DEPTH:{l||Ki?.(P.displayMode==="dbg-depth-pyramid"?"nanite":"dbg-depth-pyramid"),i.preventDefault(),i.stopPropagation();break}}};return t.addEventListener("keydown",i=>o(i,!0)),t.addEventListener("keyup",i=>o(i,!1)),e.style.touchAction="pinch-zoom",e.addEventListener("pointerdown",()=>{r.touching=!0}),e.addEventListener("pointerup",()=>{r.touching=!1}),e.addEventListener("pointermove",i=>{r.touching=i.pointerType=="mouse"?(i.buttons&1)!==0:!0,r.touching&&(r.x+=i.movementX,r.y+=i.movementY)}),e.addEventListener("wheel",i=>{r.touching=(i.buttons&1)!==0,r.touching&&(r.zoom+=Math.sign(i.deltaY),i.preventDefault(),i.stopPropagation())},{passive:!1}),()=>{let i={directions:{...n},mouse:{...r}};return r.x=0,r.y=0,r.zoom=0,i}}function Hs(t,e,n,r){if(!bd(t.cameraFrustum,n,r.bounds))return 0;let o=[...r.roots],i=r.naniteVisibilityBufferCPU;i.prepareForDraw();let l=xd(t,e,i,n);for(;o.length>0;){let c=o.pop();i.setVisited(c.id);let m=vd(l,c);if(m===0)i.setDrawn(c);else if(m===1)for(let h=0;h<c.createdFrom.length;h++){let g=c.createdFrom[h];g&&!i.wasVisited(g.id)&&(i.setVisited(c.id),o.push(g))}}return i.drawnMeshletsCount}var Un=Bt.create();function bd(t,e,n){if(!P.cullingMeshlets.frustumCulling)return!0;Un[0]=n.sphere.center[0],Un[1]=n.sphere.center[1],Un[2]=n.sphere.center[2],Un[3]=1;let r=mn(e,Un,Un);return r[3]=n.sphere.radius,t.isInside(r)}function vd(t,e){let n=t(e.sharedSiblingsBounds,e.maxSiblingsError),r=t(e.parentBounds,e.parentError),o=P.nanite.render.errorThreshold;return r>o&&n<=o?0:1}function xd(t,e,n,r){let o=us(r,t.viewMatrix,t.projMatrix,n.mvpMatrix),i=t.viewport.height;return function(c,m){if(m===1/0||c==null)return 1/0;let h=yd(o,c.center),g=m;return e*g/Math.sqrt(h-g*g)*i/2}}var oo=(t=De.fovDgr)=>{let e=dn(t);return 1/Math.tan(e/2)};function yd(t,e){let n=t[0]*e[0]+t[4]*e[1]+t[8]*e[2]+t[12],r=t[1]*e[0]+t[5]*e[1]+t[9]*e[2]+t[13],o=t[2]*e[0]+t[6]*e[1]+t[10]*e[2]+t[14];return n*n+r*r+o*o}var js=1,Ws=2,Ys=32,qs=64,Xs=65536,fe=class t{static SHADER_SNIPPET=e=>`
...
`;var wd=(t,e,n,r)=>{let o=(i,l)=>{let c=`${t}[${l}u]`,m=l==0?", default":"";return`case ${l}u ${m}: { ${r(c)} }`};return`
  switch (${n}) {
      ${Ve(e).map(o).join(`
`)}
  }`},Ks=(t,e,n,r)=>{let[o,i]=t.split(":").map(c=>c?.trim());if(o==null||i==null)throw new Error(`assignValueFromConstArray expected newVarDecl param to include variable name and type e.g. 'normal: vec3f'. Got '${t}', where name='${o}', type=${i}`);if(!zr)return`let ${t} = ${e}[${r}];`;let l=wd(e,n,r,c=>`${o} = ${c};`);return`var ${t};
...
`;var Tr={attributes:[{shaderLocation:0,offset:0,format:"float32x3"}],arrayStride:mr,stepMode:"vertex"},lo=[Tr,{attributes:[{shaderLocation:1,offset:0,format:"float32x3"}],arrayStride:mr,stepMode:"vertex"},{attributes:[{shaderLocation:2,offset:0,format:"float32x2"}],arrayStride:Ni,stepMode:"vertex"}];var uo=class t{static NAME=t.name;renderPipeline;bindingsCache=new Me;drawnMeshletsCount=0;drawnTriangleCount=0;culledInstancesCount=0;constructor(e,n){this.renderPipeline=t.createRenderPipeline(e,n)}static createRenderPipeline(e,n){let r=e.createShaderModule({label:be(t),code:Zs()});return e.createRenderPipeline({label:ve(t),layout:"auto",vertex:{module:r,entryPoint:"main_vs",buffers:lo},fragment:{module:r,entryPoint:"main_fs",targets:[{format:n}]},primitive:yt,depthStencil:Ze})}initFrameStats(){this.drawnMeshletsCount=0,this.drawnTriangleCount=0,this.culledInstancesCount=0}uploadFrameStats({scene:e}){ro(e,this.drawnMeshletsCount,this.drawnTriangleCount)}draw(e,n,r){let{cmdBuf:o,profiler:i,depthTexture:l,hdrRenderTexture:c}=e,m=i?.startRegionCpu("VisibilityCheckCPU"),h=o.beginRenderPass({label:t.NAME,colorAttachments:[Oe(c,Le(),r)],depthStencilAttachment:je(l,r),timestampWrites:i?.createScopeGpu(t.NAME)});h.setPipeline(this.renderPipeline),this.renderNaniteObject(e,h,n),i?.endRegionCpu(m),h.end()}renderNaniteObject(e,n,r){let o=r.instances.transforms,i=this.bindingsCache.getBindings(r.name,()=>this.createBindings(e,r));n.setBindGroup(0,i),n.setVertexBuffer(0,r.originalMesh.vertexBuffer),n.setVertexBuffer(1,r.originalMesh.normalsBuffer),n.setVertexBuffer(2,r.originalMesh.uvBuffer),n.setIndexBuffer(r.buffers.indexBuffer,"uint32");let l=oo();for(let c=0;c<o.length;c++){let m=o[c],h=Hs(e,l,m,r);if(h===0){this.culledInstancesCount+=1;continue}this.drawnMeshletsCount+=h;for(let g=0;g<h;g++){let _=r.naniteVisibilityBufferCPU.drawnMeshlets[g],x=_.triangleCount,T=x*le;n.drawIndexed(T,1,_.firstIndexOffset,0,c),this.drawnTriangleCount+=x}}}createBindings=({device:e,globalUniforms:n,scene:r},o)=>{let i=Ji.bindings,l=eo(r,o);return Ie(l),xe(t,o.name,e,this.renderPipeline,[n.createBindingDesc(i.renderUniforms),{binding:i.instancesTransforms,resource:{buffer:o.instances.transformsBuffer}},{binding:i.diffuseTexture,resource:l},{binding:i.sampler,resource:r.samplerLinear}])}};var Ed=Math.PI/2,Gn=0,co=1,fo=class{_viewMatrix=_e.identity();_tmpMatrix=_e.identity();_angles=[0,0];_position=[0,0,0];constructor(e=De.position){this.resetPosition(e)}get positionWorldSpace(){return this._position}resetPosition=(e=De.position)=>{e.position?.length===3&&(this._position[0]=e.position[0],this._position[1]=e.position[1],this._position[2]=e.position[2]),e.rotation?.length===2&&(this._angles[Gn]=e.rotation[1],this._angles[co]=e.rotation[0])};update(e,n){this.applyMovement(e,n),this.applyRotation(e,n),this.updateShownStats()}applyMovement(e,n){let r=(h,g)=>(h?1:0)-(g?1:0),o=n.directions,i=e*(o.goFaster?P.movementSpeedFaster:P.movementSpeed),l=[0,0,0,1];l[0]=i*r(o.right,o.left),l[1]=i*r(o.up,o.down),l[2]=i*r(o.backward,o.forward);let c=_e.transpose(this.getRotationMat(),this._tmpMatrix),m=mn(c,l,l);Y.add(this._position,m,this._position)}applyRotation(e,n){let r=n.mouse.x*e*P.rotationSpeed,o=n.mouse.y*e*P.rotationSpeed;this._angles[co]+=r,this._angles[Gn]+=o;let i=Ed*.95;this._angles[Gn]=pn(this._angles[Gn],-i,i)}updateShownStats(){let e=o=>o.toFixed(1),n=this._position,r=this._angles;ne.update("Camera pos WS",`[${e(n[0])}, ${e(n[1])}, ${e(n[2])}]`),ne.update("Camera rot",`[${e(r[co])}, ${e(r[Gn])}]`)}getRotationMat(){let e=this._angles,n=_e.identity(this._tmpMatrix);return _e.rotateX(n,e[Gn],n),_e.rotateY(n,e[co],n),n}get viewMatrix(){let e=this.getRotationMat(),n=this._position;return _e.translate(e,[-n[0],-n[1],-n[2]],this._viewMatrix)}};var Md={bindings:{renderUniforms:0}},Sd=Md.bindings,Qs=()=>`
...
`;var mo=class t{static NAME=t.name;renderPipeline;uniformsBindings;constructor(e,n,r){this.renderPipeline=t.createRenderPipeline(e,n),this.uniformsBindings=no(t,e,this.renderPipeline,[r.createBindingDesc(0)])}static createRenderPipeline(e,n){let r=e.createShaderModule({label:be(t),code:Qs()});return e.createRenderPipeline({label:ve(t),layout:"auto",vertex:{module:r,entryPoint:"main_vs",buffers:[Tr]},fragment:{module:r,entryPoint:"main_fs",targets:[{format:n}]},primitive:yt,depthStencil:Ze})}draw(e){let{cmdBuf:n,profiler:r,depthTexture:o,hdrRenderTexture:i,scene:l}=e,c=n.beginRenderPass({label:t.NAME,colorAttachments:[Oe(i,Le())],depthStencilAttachment:je(o),timestampWrites:r?.createScopeGpu(t.NAME)});c.setPipeline(this.renderPipeline),c.setBindGroup(0,this.uniformsBindings);let[m,h]=gn(l),g=m.meshoptimizerLODs[P.dbgMeshoptimizerLodLevel];c.setVertexBuffer(0,g.vertexBuffer),c.setIndexBuffer(g.indexBuffer,"uint32");let _=g.triangleCount*le;c.drawIndexed(_,1,0,0,0),c.end()}};var Zi={bindings:{renderUniforms:0}},Pd=Zi.bindings,el=()=>`
...
`,zn=3*Dt+os;function tl(t,e,n){return t.createBuffer({label:`${e}-nanite-meshlets`,size:n*zn,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.STORAGE})}function nl(t,e,n){let r=n.length,o=r*zn;if(o!==e.size)throw new Error(`GPU meshlet data preallocated ${e.size} bytes, but ${o} bytes (${r} meshlets * ${zn}) are needed`);let i=0,l=new ArrayBuffer(zn),c=new Float32Array(l),m=new Uint32Array(l);n.forEach(h=>{c[0]=h.sharedSiblingsBounds.center[0],c[1]=h.sharedSiblingsBounds.center[1],c[2]=h.sharedSiblingsBounds.center[2],c[3]=h.maxSiblingsError,c[4]=h.parentBounds?.center[0]||0,c[5]=h.parentBounds?.center[1]||0,c[6]=h.parentBounds?.center[2]||0,c[7]=h.parentError===1/0?9999999:h.parentError;let g=h.ownBounds.sphere;c[8]=g.center[0],c[9]=g.center[1],c[10]=g.center[2],c[11]=g.radius,m[12]=h.triangleCount,m[13]=h.firstIndexOffset,m[14]=h.lodLevel,t.queue.writeBuffer(e,i,l,0,zn),i+=zn})}var ho=class{visitedMeshlets=[];drawnMeshlets=[];drawnMeshletsCount=0;mvpMatrix=_e.identity();initialize(e){this.visitedMeshlets=Array(e),this.drawnMeshlets=Array(e)}prepareForDraw(){for(let e=0;e<this.visitedMeshlets.length;e++)this.visitedMeshlets[e]=!1;this.drawnMeshletsCount=0}wasVisited=e=>this.visitedMeshlets[e];setVisited=e=>{this.visitedMeshlets[e]=!0};setDrawn=e=>{this.drawnMeshlets[this.drawnMeshletsCount]=e,this.drawnMeshletsCount+=1}};var _o=0,$n=class{constructor(e,n,r,o,i,l){this.name=e;this.bounds=n;this.originalMesh=r;this.buffers=o;this.impostor=i;this.instances=l}allMeshlets=[];naniteVisibilityBufferCPU=new ho;diffuseTexture=void 0;diffuseTextureView=void 0;roots=[];lodLevelCount=0;find=e=>this.allMeshlets.find(n=>n.id===e);contains=e=>this.find(e)!==void 0;get totalTriangleCount(){return this.allMeshlets.reduce((e,n)=>e+n.triangleCount,0)}get totalIndicesCount(){return le*this.totalTriangleCount}get meshletCount(){return this.allMeshlets.length}get instancesCount(){return this.instances.transforms.length}get bottomTriangleCount(){return this.allMeshlets.reduce((e,n)=>n.lodLevel===_o?e+n.triangleCount:e,0)}get bottomMeshletCount(){return this.allMeshlets.reduce((e,n)=>n.lodLevel===_o?e+1:e,0)}bindInstanceTransforms=e=>({binding:e,resource:{buffer:this.instances.transformsBuffer}});finalizeNaniteObject(e){this.naniteVisibilityBufferCPU.initialize(this.meshletCount),nl(e,this.buffers.meshletsDataBuffer,this.allMeshlets)}addMeshlet(e,n,r,o){let i=this.find(n.id);if(i)return i;let l={id:n.id,lodLevel:n.lodLevel,sharedSiblingsBounds:n.sharedSiblingsBounds,maxSiblingsError:n.maxSiblingsError,parentBounds:n.parentBounds,parentError:n.parentError,firstIndexOffset:r,triangleCount:Ce(n.indices),createdFrom:[],ownBounds:o};return this.allMeshlets.push(l),this.lodLevelCount=Math.max(this.lodLevelCount,l.lodLevel+1),e?e.createdFrom.push(l):this.roots.push(l),l}printStats(){cn||(console.log("All meshlets:",this.allMeshlets),console.log("Root meshlets:",this.roots));let e=this.bottomTriangleCount,n=this.roots.reduce((o,i)=>o+i.triangleCount,0),r=n/e*100;console.log(`Created ${this.lodLevelCount} LOD levels. Total ${this.meshletCount} meshlets.`),console.log(`There are ${this.bottomMeshletCount} bottom level meshlets with ${e} triangles.`),console.log(`There are ${this.roots.length} root meshlets with ${n} triangles. Simplification: ${r.toFixed(1)}%.`)}};var rl=(t,e)=>`
...
${e=="read"?Ad:Td}
`;function ol(t,e,n,r){let i=n.filter(l=>l.lodLevel===_o).length*r*rs;return t.createBuffer({label:`${e}-nanite-drawn-meshlets`,size:_t+Hn+i,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.INDIRECT|GPUBufferUsage.COPY_DST|GPUBufferUsage.COPY_SRC})}async function il(t,e){let n=e.buffers.drawnMeshletsBuffer,r=await br(t,Uint32Array,n),o=Id(r);return console.log(`[${e.name}] Drawn meshlets buffer`,o),o}function Id(t){let e=(_t+Hn)/q,n=_=>({transformId:t[e+2*_],meshletId:t[e+2*_+1]}),r=t.slice(0,4),o=r[1],i=Ve(o).map((_,x)=>n(x)),l=_t/q,c=t.slice(l,l+4),m=c[3],h=(t.length-e)/2,g=Ve(m).map((_,x)=>n(h-1-x));return{hardwareRaster:{vertexCount:r[0],meshletCount:o,firstVertex:r[2],firstInstance:r[3],meshletIds:i},softwareRaster:{workgroupsX:c[0],workgroupsY:c[1],workgroupsZ:c[2],meshletCount:m,meshletIds:g}}}function bn(t,e){let n=e?Bd(t,e):vo(t);return{box:n,sphere:Dd(n)}}function Rd(t,e=fn,n){let r=t.length/e,o=[0,0,0];for(let i=0;i<r;i++){let l=i*e;o[0]=t[l],o[1]=t[l+1],o[2]=t[l+2],n(o)}}function Cd(t,e,n){let r=[0,0,0];for(let o=0;o<e.length;o++){let i=e[o]*le;r[0]=t[i],r[1]=t[i+1],r[2]=t[i+2],n(r)}}function bo(){let t=[void 0,void 0,void 0],e=[void 0,void 0,void 0];return[[e,t],r=>{for(let o=0;o<3;o++)t[o]=t[o]!==void 0?Math.max(t[o],r[o]):r[o],e[o]=e[o]!==void 0?Math.min(e[o],r[o]):r[o]}]}function vo(t,e=fn){let[n,r]=bo();return Rd(t,e,r),n}function Bd(t,e){let[n,r]=bo();return Cd(t,e,r),n}function al(t,e){return t?.center[0]===e?.center[0]&&t?.center[1]===e?.center[1]&&t?.center[2]===e?.center[2]&&t?.radius===e?.radius}function Dd([t,e]){let n=Y.midpoint(t,e),r=Y.distance(n,e);return{center:n,radius:r}}function sl(t,e=fn){let[n,r]=vo(t,e),o=i=>"["+i.map(l=>l.toFixed(2)).join(",")+"]";console.log("Bounding box min:",o(n)),console.log("Bounding box max:",o(r))}var ll=t=>`
...
`;function ul(t,e,n){let r=n.length/3,o=2**21,[i,l]=vo(n),c=Y.sub(l,i),m=Y.create(o/c[0],o/c[1],o/c[2]),h=Y.mul(i,Y.negate(m)),g=Y.create(),_=R=>Math.floor(Math.min(R,o-1)),x=8,T=new Uint32Array(x+r*2);for(let R=0;R<r;R++){Y.set(n[R*3],n[R*3+1],n[R*3+2],g),Y.mul(g,m,g),Y.add(g,h,g);let C=_(g[0]),N=_(g[1]),L=_(g[2]);T[x+R*2+0]=C,T[x+R*2+0]+=(N&2047)<<21,T[x+R*2+1]=(N&2095104)>>11,T[x+R*2+1]+=L<<10}let S=Y.inverse(m),w=Y.addScaled(i,S,.5),E=new Float32Array(T.buffer,0,8);return E[0]=S[0],E[1]=S[1],E[2]=S[2],E[4]=w[0],E[5]=w[1],E[6]=w[2],Ht(t,`${e}-nanite-vertex-buffer-vec4`,GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST,T)}var cl=P.useVertexQuantization,Od=t=>`
...
`,xo=cl?ll:Od;function Nd(t,e,n){let r=n.length/3,o=new Float32Array(r*4);for(let i=0;i<r;i++)o[i*4]=n[i*3],o[i*4+1]=n[i*3+1],o[i*4+2]=n[i*3+2],o[i*4+3]=1;return Ht(t,`${e}-nanite-vertex-buffer-vec4`,GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST,o)}var fl=cl?ul:Nd;var yo=t=>`
...
`;function dl(t,e,n){let r=n.length/3,o=new Float32Array(r*2),i=Y.create();for(let l=0;l<r;l++){Y.set(n[l*3],n[l*3+1],n[l*3+2],i);let c=Math.abs(i[0])+Math.abs(i[1])+Math.abs(i[2]);if(Y.mulScalar(i,1/c,i),i[2]<0){let m=i[0],h=i[1];i[0]=(1-Math.abs(h))*(m>=0?1:-1),i[1]=(1-Math.abs(m))*(h>=0?1:-1)}o[2*l]=i[0]*.5+.5,o[2*l+1]=i[1]*.5+.5}return Ht(t,`${e}-nanite-octahedron-normals`,GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST,o)}var ml=t=>`
...
`,Ar=Math.max(hn,4*q);function hl(t,e,n){let r=q*n;return t.createBuffer({label:`${e}-nanite-billboards`,size:Ar+r,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.INDIRECT|GPUBufferUsage.COPY_DST|GPUBufferUsage.COPY_SRC})}async function _l(t,e){let n=e.buffers.drawnImpostorsBuffer,r=await br(t,Uint32Array,n),o=r[1],i=Ar/q,l=r.slice(i,i+o),c={vertexCount:r[0],impostorCount:o,firstVertex:r[2],firstInstance:r[3],idsList:l};return console.log(`[${e.name}] Drawn impostors buffer`,c),c}var Yn=(t,e)=>`
...
`,Wn=Math.max(hn,3*q+q+q+Dt),Eo=(t,e)=>`
@group(0) @binding(${t})
var<storage, ${e}> _drawnInstancesList: array<u32>;
`;function gl(t,e,n,r,o){let i=q*r,l=t.createBuffer({label:`${e}-nanite-drawn-instances-ids`,size:Wn+i,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.INDIRECT|GPUBufferUsage.COPY_DST|GPUBufferUsage.COPY_SRC});return Ud(t,l,n,o),l}function Ud(t,e,n,r){let o=new ArrayBuffer(Wn),i=new Float32Array(o),l=new Uint32Array(o),c=4;i[c+0]=r.center[0],i[c+1]=r.center[1],i[c+2]=r.center[2],i[c+3]=r.radius,l[c+4]=n,t.queue.writeBuffer(e,0,o,0,Wn)}var Mo=t=>`

@group(0) @binding(${t})
var<storage, read> _indexBuffer: array<u32>;
`,qn=class{indexBuffer=void 0;meshletsDataBuffer=void 0;vertexPositionsBuffer=void 0;vertexNormalsBuffer=void 0;vertexUVsBuffer=void 0;drawnInstancesBuffer=void 0;drawnImpostorsBuffer=void 0;drawnMeshletsBuffer=void 0;constructor(e,n,r,o,i,l){P.isTest&&e==null||(this.indexBuffer=Fd(e,n,i),this.vertexPositionsBuffer=fl(e,n,o.positions),this.vertexNormalsBuffer=dl(e,n,o.normals),this.vertexUVsBuffer=r.uvBuffer,this.meshletsDataBuffer=tl(e,n,i.length),this.drawnMeshletsBuffer=ol(e,n,i,l),this.drawnInstancesBuffer=gl(e,n,i.length,l,o.bounds.sphere),this.drawnImpostorsBuffer=hl(e,n,l))}bindIndexBuffer=e=>({binding:e,resource:{buffer:this.indexBuffer}});bindVertexPositions=e=>({binding:e,resource:{buffer:this.vertexPositionsBuffer}});bindVertexNormals=e=>({binding:e,resource:{buffer:this.vertexNormalsBuffer}});bindVertexUVs=e=>({binding:e,resource:{buffer:this.vertexUVsBuffer}});bindMeshletData=e=>({binding:e,resource:{buffer:this.meshletsDataBuffer}});cmdClearDrawnMeshletsParams(e){let n=0;e.clearBuffer(this.drawnMeshletsBuffer,n,4*q),n=_t,e.clearBuffer(this.drawnMeshletsBuffer,n,4*q)}cmdDrawMeshletsHardwareIndirect(e){e.drawIndirect(this.drawnMeshletsBuffer,0)}cmdDrawMeshletsSoftwareIndirect(e){e.dispatchWorkgroupsIndirect(this.drawnMeshletsBuffer,_t)}bindDrawnMeshletsParams=e=>({binding:e,resource:{buffer:this.drawnMeshletsBuffer,offset:0,size:_t}});bindDrawnMeshletsSwParams=e=>({binding:e,resource:{buffer:this.drawnMeshletsBuffer,offset:_t,size:Hn}});bindDrawnMeshletsList=e=>({binding:e,resource:{buffer:this.drawnMeshletsBuffer,offset:_t+Hn}});_mockMeshletSoftwareDraw(e,n){e.queue.writeBuffer(this.drawnMeshletsBuffer,_t,n)}_mockMeshletsDrawList(e,n){if(n.length%2!==0)throw new Error("Invalid list provided to _mockMeshletsDrawList(). Should have even length.");e.queue.writeBuffer(this.drawnMeshletsBuffer,_t+Hn,n)}cmdClearDrawnInstancesDispatchParams(e){e.clearBuffer(this.drawnInstancesBuffer,0,4*q)}bindDrawnInstancesParams=e=>({binding:e,resource:{buffer:this.drawnInstancesBuffer,offset:0,size:Wn}});bindDrawnInstancesList=e=>({binding:e,resource:{buffer:this.drawnInstancesBuffer,offset:Wn}});cmdClearDrawnImpostorsParams(e){e.clearBuffer(this.drawnImpostorsBuffer,0,4*q)}bindDrawnImpostorsParams=e=>({binding:e,resource:{buffer:this.drawnImpostorsBuffer,offset:0,size:Ar}});bindDrawnImpostorsList=e=>({binding:e,resource:{buffer:this.drawnImpostorsBuffer,offset:Ar}})};function Fd(t,e,n){let r=n.reduce((i,l)=>i+Ce(l.indices),0),o=P.isExporting?GPUBufferUsage.COPY_SRC:0;return t.createBuffer({label:`${e}-nanite-index-buffer`,size:Yr(r),usage:GPUBufferUsage.INDEX|GPUBufferUsage.COPY_DST|GPUBufferUsage.STORAGE|o})}var Qi={bindings:{renderUniforms:0,meshlets:1,drawnMeshletIds:2,instancesTransforms:3,vertexPositions:4,vertexNormals:5,vertexUV:6,indexBuffer:7,diffuseTexture:8,sampler:9}},Mt=Qi.bindings,bl=()=>`
...
`;function Zn(t){t.draw(3)}var Tl={bindings:{renderUniforms:0,depthPyramidTexture:1}},Pl=Tl.bindings,kd=()=>`
...
`,Co=class t{static NAME=t.name;renderPipeline;bindingsCache=new Me;constructor(e,n){this.renderPipeline=t.createRenderPipeline(e,n)}static createRenderPipeline(e,n){let r=e.createShaderModule({label:be(t),code:kd()});return e.createRenderPipeline({label:ve(t),layout:"auto",vertex:{module:r,entryPoint:"main_vs",buffers:[]},fragment:{module:r,entryPoint:"main_fs",targets:[{format:n}]},primitive:{topology:"triangle-list"}})}onViewportResize=()=>this.bindingsCache.clear();cmdDraw(e){let{cmdBuf:n,profiler:r,hdrRenderTexture:o,depthTexture:i}=e,l=n.beginRenderPass({label:t.NAME,colorAttachments:[Oe(o,Le())],timestampWrites:r?.createScopeGpu(t.NAME)}),c=this.bindingsCache.getBindings(i.label,()=>this.createBindings(e));l.setBindGroup(0,c),l.setPipeline(this.renderPipeline),Zn(l),l.end()}createBindings=({device:e,globalUniforms:n,prevFrameDepthPyramidTexture:r})=>{let o=Tl.bindings;return xe(t,"000",e,this.renderPipeline,[n.createBindingDesc(o.renderUniforms),{binding:o.depthPyramidTexture,resource:r}])}};var Rr={workgroupSizeX:32,maxWorkgroupsY:32768,maxMeshletTriangles:`${P.nanite.preprocess.meshletMaxTriangles}u`,bindings:{renderUniforms:0,instancesTransforms:1,dispatchIndirectParams:2,drawnInstanceIdsResult:3,billboardsParams:4,billboardsIdsResult:5,depthPyramidTexture:6,depthSampler:7}},Al=Rr,Jt=Rr.bindings,Il=()=>`
...
`;var Lo=class t{static NAME=t.name;pipeline;bindingsCache=new Me;constructor(e,n){let r=e.createShaderModule({label:be(t),code:Nl()});this.pipeline=e.createRenderPipeline({label:ve(t),layout:"auto",vertex:{module:r,entryPoint:"main_vs",buffers:[]},fragment:{module:r,entryPoint:"main_fs",targets:[{format:n,blend:{color:{srcFactor:"src-alpha",dstFactor:"one-minus-src-alpha",operation:"add"},alpha:{srcFactor:"one",dstFactor:"one",operation:"add"}}}]},primitive:{topology:"triangle-list"},depthStencil:Ze})}onViewportResize=()=>this.bindingsCache.clear();cmdCombineRasterResults(e){let{cmdBuf:n,profiler:r,hdrRenderTexture:o,rasterizerSwResult:i,depthTexture:l}=e;Ie(o);let c=n.beginRenderPass({label:t.NAME,colorAttachments:[Oe(o,Le(),"load")],depthStencilAttachment:je(l,"load"),timestampWrites:r?.createScopeGpu(t.NAME)}),m=this.bindingsCache.getBindings(l.label,()=>this.createBindings(e,i));c.setBindGroup(0,m),c.setPipeline(this.pipeline),Zn(c),c.end()}createBindings=({device:e,globalUniforms:n},r)=>{let o=ra.bindings;return xe(t,t.NAME,e,this.pipeline,[n.createBindingDesc(o.renderUniforms),{binding:o.softwareRasterizerResult,resource:{buffer:r}}])}};var Gd=(De.far-De.near)/65535*100,Ul={bindings:{renderUniforms:0}},zd=Ul.bindings,Vd=(t,e,n)=>`
